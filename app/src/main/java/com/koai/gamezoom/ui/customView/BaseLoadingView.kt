...
import com.koai.gamezoom.databinding.GameLoadingBinding

class BaseLoadingView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null
) : ConstraintLayout(context, attrs) {
    private var binding: GameLoadingBinding
    ...
    init {
        ...
        rotate.duration = 800
        binding = GameLoadingBinding.inflate(LayoutInflater.from(context), this, true)
