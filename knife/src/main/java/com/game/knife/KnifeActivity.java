...
public class KnifeActivity extends AppCompatActivity implements UtilsAwv.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_knife);
        init_screen();
    ...
    public void openQuitDialog() {
        ...
        alert = new androidx.appcompat.app.AlertDialog.Builder(KnifeActivity.this);
