...
public class BlockPuzzleActivity extends AppCompatActivity implements UtilsAwv.Listener {
    ...
    public void openQuitDialog() {
        ...
        alert = new androidx.appcompat.app.AlertDialog.Builder(BlockPuzzleActivity.this);
