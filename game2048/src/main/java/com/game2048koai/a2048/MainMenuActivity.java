package com.game2048koai.a2048;
...
//                break;
            ...
            Intent bazaarIntent = new Intent(Intent.ACTION_VIEW);
            bazaarIntent.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.koai.gamezoom"));
            try {
