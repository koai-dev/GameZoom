...
! function(t) {
    ...
    var e = (t.eFileType, function() {
        function t() {}
        return t.prototype.processed = function() {
            this.popMinDefsStack()
        }, t.prototype.setMinimized = function(t, e) {
            void 0 === e && (e = null), this._minimized = t, this._minDefs = e, t && (this._minDefsStack = [], null === e)
...
! function(t) {
    var e = function(e) {
        ...
        return __extends(i, e), i.prototype.getType = function() {
            ...
            return new t.File(n, this.getFileNameWithoutExtension(r), o, 1 - s)
            ...
            for (var m = 0, T = !1, b = 0, v = !1, I = 0, E = 0, u = this._bin.getUint8(this._tmpPosition++) - 1; u >= 0; u--) switch (this._bin.getUint8(this._tmpPosition++)) {
                case i.ATTR_BONE_X:
                case i.ATTR_OBJ_X:
                ...
                case i.ATTR_OBJ_PIVOT_Y:
                    b = this.readFixed16_16(), v = !0;
                    break;
                case i.ATTR_OBJ_ALPHA:
                    g.alpha = this.readFixed1_7()
            }
            if (y) {
                d.setFolderAndFile(I, E);
                var N = r.getFolderById(I).getFileById(E);
                g.pivotX = T ? m : N.pivotX, g.pivotY = 1 - (v ? b : 1 - N.pivotY)
            }
            return d
...
! function(t) {
    var e = function(e) {
        ...
        return __extends(i, e), i.prototype.getType = function() {
            ...
            return void 0 !== e.type && "sound" === e.type ? null : new t.File(this.parseInt(e, "id"), this.getFileNameWithoutExtension(this.parseString(e, "name")), this.parseFloat(e, "pivot_x"), 1 - this.parseFloat(e, "pivot_y"))
...
! function(t) {
    var e = function(e) {
        ...
        return __extends(i, e), i.prototype.getType = function() {
            ...
            return e.hasAttribute("type") && "sound" === e.getAttribute("type") ? null : new t.File(this.parseInt(e, "id"), this.getFileNameWithoutExtension(this.parseString(e, "name")), this.parseFloat(e, "pivot_x"), 1 - this.parseFloat(e, "pivot_y"))
        }, i.prototype.getTag = function(e) {
            return new t.Item(this.parseInt(e, "id"), this.parseString(e, "name"))
        }, i.prototype.getEntity = function(e) {
            return new t.Entity(this.parseInt(e, "id"), this.parseString(e, "name"))
