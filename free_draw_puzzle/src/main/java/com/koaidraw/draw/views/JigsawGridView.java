...
package com.koaidraw.draw.views;

import static com.koaidraw.draw.util.Constants.INVALID_ID;
import static com.koaidraw.draw.util.Constants.MOVE_DURATION;
import static com.koaidraw.draw.util.Constants.SMOOTH_SCROLL_AMOUNT_AT_EDGE;
...
import com.koaidraw.draw.R;
import com.koaidraw.draw.adapter.OrderableAdapter;
import com.koaidraw.draw.util.GridUtil;
