...
package com.koaidraw.draw.dao.impl;

import static com.koaidraw.draw.util.Base64Util.base64ToBitmap;
import static com.koaidraw.draw.util.DBUtil.ALL_COLUMNS;
import static com.koaidraw.draw.util.DBUtil.DESC_COLUMN;
import static com.koaidraw.draw.util.DBUtil.ID_COLUMN;
import static com.koaidraw.draw.util.DBUtil.ID_SELECTION;
import static com.koaidraw.draw.util.DBUtil.IMAGE_COLUMN;
import static com.koaidraw.draw.util.DBUtil.JIGSAW_TABLE;
import static com.koaidraw.draw.util.DBUtil.NAME_COLUMN;
import static com.koaidraw.draw.util.DBUtil.ORIGINAL_COLUMN;
import static com.koaidraw.draw.util.DBUtil.ORIGINAL_SELECTION;
import static com.koaidraw.draw.util.DBUtil.ORIGINAL_SELECTION_NULL;
import static com.koaidraw.draw.util.DBUtil.getIdArguments;
import static com.koaidraw.draw.util.EntityUtil.entityToContentValues;
...
import com.koaidraw.draw.dao.ImageDao;
import com.koaidraw.draw.db.JigsawDB;
import com.koaidraw.draw.model.ImageEntity;

import java.util.ArrayList;
import java.util.List;

/**
 * Default implementation for {@link com.koaidraw.draw.dao.ImageDao}. Provides CRUD database operations for {@link
 * com.koaidraw.draw.model.ImageEntity}
 *
