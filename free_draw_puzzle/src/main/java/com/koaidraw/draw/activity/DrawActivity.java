...
import static com.koaidraw.draw.util.ToastUtil.shortToast;
...
import com.koaidraw.draw.tasks.JigsawGenerator;
import com.koaidraw.draw.views.DrawingView;
...
public class DrawActivity
     ...
     */
    private void init() {
        setContentView(R.layout.activity_main_draw_puzzle);
        initViews();
